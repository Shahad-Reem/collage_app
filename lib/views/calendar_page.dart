                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return CalendarDates(
                      day: days[index],
                      date: dates[index],
                      dayColor: index == 0 ? CustomColors.kRed : Colors.black54,
                      dateColor: index == 0
                          ? CustomColors.kRed
